...
export const TicketDetailPage = () => {
        ...
        <div className="text-center py-12 space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">
              Vé bạn đang tìm không tồn tại hoặc đã bị xóa.
            </p>
            <Button
              variant="outline"
              onClick={() => navigate('/tickets')}
  ...
  return (
    <DetailPageLayout
     title="Quản lý vé"
        description="Danh sách tất cả vé và quyền hạn"
      objectName={item.name || 'Chi tiết vé'}
      breadcrumbItems={[
        { label: 'Quản lý vé', href: '/tickets' },
    ...
    >
      {/* Detail Content */}
      <TicketProfile ticket={item} />

      {/* Delete Confirmation Dialog */}
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Xóa vé?</DialogTitle>
            <DialogDescription>
              Hành động này không thể hoàn tác. Vé sẽ bị xóa vĩnh viễn.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
